 ...
 * 2. 该组件接收 NotificationsProps 确定 prefixCls、motion 等样式相关的东西
 * 3. 通过 NotificationsRef.open() 添加 configList 打开提示，configList 接收的是 OpenConfig 参数，OpenConfig 会通过 NoticeList 组件传给 Notice
 * @example
 * <Notifications
